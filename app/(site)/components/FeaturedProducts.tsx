    ...
    <div className="px-4 py-8 h-auto w-full">
      <div className="container mx-auto">
        <div className="flex items-center justify-between mb-8">
          <h1 className="md:text-4xl text-2xl font-semibold"> Products</h1>
          <SwiperBtn
              ...
              <SwiperSlide key={index}>
                <div className="grid grid-cols-2 gap-3 h-full">
                  {product.items.map((item, idx) => (
                    <div
                      key={idx}
                      className="bg-gray-100 p-2 rounded-md flex flex-col gap-2 justify-between items-center"
                    >
                      <Image
                      ...
                      <Link
                        href=""
                        className="bg-white p-3 rounded-md w-full group hover:bg-primary transition-all duration-150"
                      >
